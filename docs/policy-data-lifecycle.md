...
As of **v10.0.27**, the bundled catalog contains **222** controls: **70** are `lifecycle: stable` and **152** are `lifecycle: experimental`. There are no `deprecated` controls in the current catalog.
