...
| Area | What you get |
|---|---|
| Current public release | `v9.0.1` (PyPI package `oss-policy-kit`) <!-- x-release-please-version --> |
| Runtime | Python 3.12+ |
...
## v9.0.1 baseline <!-- x-release-please-version -->

| Area | v9.0.1 <!-- x-release-please-version --> |
|---|---|
