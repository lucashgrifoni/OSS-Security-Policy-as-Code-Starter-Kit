...
| Area | What you get |
|---|---|
| Current public release | `v11.0.0` (PyPI package `oss-policy-kit`) <!-- x-release-please-version --> |
| Runtime | Python 3.12+ |
...
## v11.0.0 baseline <!-- x-release-please-version -->

| Area | v11.0.0 <!-- x-release-please-version --> |
|---|---|
