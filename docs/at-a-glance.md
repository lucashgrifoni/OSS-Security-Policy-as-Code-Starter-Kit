...
| Area | What you get |
|---|---|
| Current public release | `v10.0.23` (PyPI package `oss-policy-kit`) <!-- x-release-please-version --> |
| Runtime | Python 3.12+ |
...
## v10.0.23 baseline <!-- x-release-please-version -->

| Area | v10.0.23 <!-- x-release-please-version --> |
|---|---|
