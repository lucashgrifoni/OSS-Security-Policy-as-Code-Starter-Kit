...
| Area | What you get |
|---|---|
| Current public release | `v7.0.2` (PyPI package `oss-policy-kit`) <!-- x-release-please-version --> |
| Runtime | Python 3.12+ |
...
## v7.0.2 baseline <!-- x-release-please-version -->

| Area | v7.0.2 <!-- x-release-please-version --> |
|---|---|
