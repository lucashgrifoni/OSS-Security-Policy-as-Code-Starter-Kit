...
| Area | What you get |
|---|---|
| Current public release | `v10.0.10` (PyPI package `oss-policy-kit`) <!-- x-release-please-version --> |
| Runtime | Python 3.12+ |
...
## v10.0.10 baseline <!-- x-release-please-version -->

| Area | v10.0.10 <!-- x-release-please-version --> |
|---|---|
