...
| Area | What you get |
|---|---|
| Current public release | `v9.0.0` (PyPI package `oss-policy-kit`) <!-- x-release-please-version --> |
| Runtime | Python 3.12+ |
...
## v9.0.0 baseline <!-- x-release-please-version -->

| Area | v9.0.0 <!-- x-release-please-version --> |
|---|---|
