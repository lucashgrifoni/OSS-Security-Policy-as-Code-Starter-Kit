...
- **Generated (UTC)**: `2026-05-19T16:49:49+00:00`
- **Kit version**: `6.0.0.dev0`
...
- **Evidence**:
  - `examples\hardened-repo\SECURITY.md`
...
- **Evidence**:
  - `examples\hardened-repo\CONTRIBUTING.md`
...
- **Evidence**:
  - `examples\hardened-repo\.github\workflows\ci.yml`
  - `examples\hardened-repo\.github\workflows\release-example.yml`
  - `examples\hardened-repo\.github\workflows\security.yml`
...
- **Evidence**:
  - `examples\hardened-repo\waivers\waivers.yaml`
