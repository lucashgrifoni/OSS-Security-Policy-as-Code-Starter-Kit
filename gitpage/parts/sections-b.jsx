...
const CAPABILITIES = [
  ...
  { icon: "package", title: "Release-hardening tracks", body: "GitHub, GitLab, Azure, and AWS all ship release-oriented profile families that extend baseline checks with evidence-driven posture expectations." },
  ...
  { icon: "shield", title: "Cross-platform parsers", body: "The package includes static parsers for GitHub Actions, GitLab CI, Azure Pipelines, and AWS CodeBuild or committed CodePipeline definitions." },
...
const FRAMEWORKS = [
  ...
  },
  {
    ...
    chips: ["16-39 controls", "evidence files", "manual review if missing"],
    accent: "from-signal/25 to-signal/0",
  },
  {
    icon: "merge",
    name: "GitLab tracks",
    code: "gitlab-level-1..3 · gitlab-release-hardening-1..3",
    text: "Cover .gitlab-ci.yml jobs, includes, runner tags, and trigger rules, plus optional merge-request evidence.",
    chips: ["16-36 controls", "clone + evidence", "static parsing"],
