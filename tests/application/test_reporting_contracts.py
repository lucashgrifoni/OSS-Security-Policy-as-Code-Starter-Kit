    ...
    return ExecutionReport(
        ...
        results=[
            ControlResult(
                ...
                profile=profile_id, evidence_sources=[], confidence="high", reason="ok", remediation="keep",
            ),
            ControlResult(
                control_id="CI-PIN-008", title="pin", category="supply_chain", status=ControlStatus.FAIL,
                profile=profile_id, evidence_sources=[], confidence="medium", reason="bad", remediation="pin",
            ),
        ],
