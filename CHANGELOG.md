...
## [7.0.0](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/compare/v6.2.0...v7.0.0) (2026-05-22)
...
* **adapters,emit-vex:** zizmor severity properties + CISA VEX minimum tests (PR-3) ([271daee](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/271daee10a69630ac8f81ed9867c66b668df91aa))
* **catalog,evaluators:** v6.0.0 control + evaluator definitions ([9101da8](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/9101da849bc5f52b28692fd2b03340977a7bb3d6))
...
* **cli:** emit-insights subcommand (OpenSSF Security Insights 1.0) (PR-8) ([8745590](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/87455902a03e745be5953b869ec547017bfcddfa))
* **cli:** evaluate/profiles UX + advisory banner + waivers updates ([4fe5090](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/4fe5090120e964bde460231e336a312249b1fa50))
* **cli:** export-evidence --format chainloop (PR-17, experimental, V6-04) ([a60d051](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/a60d051fff423581c0b75217e89271bccc57591b))
* **controls:** GH-PROV-023 promotion signal→evidence-backed (PR-12, ADR-007) ([1926067](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/1926067837ba80edb7c222bdca594c859d7aed4b))
...
* **evaluators,schemas:** GH-EGRESS-HRN-001 + verification.source enum (PR-7) ([bcc018c](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/bcc018ce348f7bd5b6e1302f7797790faceae504))
* **profiles,evaluators:** appsec-llm-ssdf-218a-1 + LLM-218A-* + AIBOM-PRESENT-001 (PR-10) ([6f18f5f](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/6f18f5f06977986d97aede2780bebe5cd04b7326))
* **profiles,evaluators:** cra-eu-ai-act-art11-1 + LLM-AI-ACT-* (PR-11) ([1a26a7d](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/1a26a7dc704d90e61dc76cd6971f4a5396288627))
* **profiles,evaluators:** gitlab-level-2 + GL-PIPE-007..012 (PR-14) ([98db17c](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/98db17cdb3b70e6137769a8f441beb51b5689f81))
* **profiles,evaluators:** oss-publish-readiness-1 + PUBLISH-OIDC-* (PR-9) ([1f02940](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/1f0294059719aa7334b96f0d9b40c4cfdc1fb996))
* **profiles,evaluators:** slsa-source-l1-1 + SLSA-SRC-* family (PR-13) ([3735ec4](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/3735ec45fea73d6aff65aa4960a0f868c29471b6))
* **profiles:** add s2c2f-l2-1 and s2c2f-l3-1 (recomposition only) (PR-6) ([1a026cb](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/1a026cbf1ad0aac27e02b021066e697995b792a8))
* **profiles:** ai-agent-baseline-1 source-side checks (AI-AGENT-*) ([f69b665](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/f69b6652f803da436ac520489724b37e0b8ff379))
* **profiles:** appsec-agentic-asi-1 + AGENT-ASI-* (PR-28) ([9322d3a](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/9322d3ad6623f9392d603b5d81a053297c474c0d))
* **profiles:** appsec-mcp-server-1 + MCP-* (PR-27) ([78f7029](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/78f7029c66c2c69c704dc9ed230560c026ab8718))
* **profiles:** bundle distroless + GH-2026 + scanner-integrity signals (PR-29..32) ([d5503d6](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/d5503d68266f2d405f1c7d117c961c0922c827dc))
* **profiles:** cra-eu-ready-2-1 + CRA Art.13/14 signals (PR-22) ([0af123f](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/0af123f45c3ed6ee890ce0c1effed76c7c4343d6))
* **profiles:** EPSS + CISA KEV triage (SCA-KEV/EPSS, PR-23) ([58dbf39](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/58dbf39c88259d6e8f8165c41d5c76e672df2165))
* **profiles:** EU AI Act Annex IV expansion (LLM-AI-ACT-*, PR-21) ([6c39aa9](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/6c39aa94855af136ba29630c3adf9e265da58e16))
* **profiles:** osps-baseline-2026-1 + Scorecard v6 conformance (PR-20) ([149c289](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/149c2897911c72eed6fca35cc4922e0bb6743c2f))
* **profiles:** slsa-source-l2-1 + SLSA-SRC-006..008 (PR-25) ([6224da7](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/6224da728afb2bfd3a44ff27fa336de8fbca6192))
* **recommend:** recommend-profile/v2 schema_version → absolute URL (PR-15, BREAKING) ([2584175](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/2584175d052367fe1ba3bd9c42603c068913a055))
* **reports:** add controls_total to reports/1.0 file payload (M-001) ([e1e67eb](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/e1e67eba4498c7077f0c51fc6c94a536b421dcd1))
* **reports:** reports/2.0 contract URL + status mapping + migration script (PR-16, V6-05, BREAKING) ([1af3d49](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/1af3d494f7d04bc6db36c91c7e3e6c86142ad7d3))
* **reports:** reports/2.0 schema dir + reporting updates ([6274595](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/62745950480c695cc2ee49a7b4808eccc32a8404))
* **sbom:** SPDX 3.0.1 detection + BSI TR-03183-2 v2.1.0 validation (PR-4) ([29322d6](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/29322d69edc66d558d30dc8b690df359c78d3ab8))
* **schema:** Rekor v2 tile-inclusion enum + 2026 ecosystem signals (PR-24/26/29-32) ([b98fd43](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/b98fd432e5b18d9b38f89a64a2a12f0f7552f841))
...
* **v5.5:** native Terraform / OpenTofu IaC posture coverage ([499e8c8](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/499e8c890fc2fb340312bc66b57c71237aa6ec19))
* **v5.6:** add container hardening pack + container-baseline-1 profile ([5728487](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/572848709ee7f42b523579b5e532f980ad5da7d5))
* **v5.6:** add scan-k8s + Kubernetes pack + kubernetes-baseline-1 profile ([857c812](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/857c8124cde261dd3fec9a5d9d645a9df8fdd2de))
* **v5.6:** add SEC-FUZZ-001 fuzzing presence signal ([9ac3e6e](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/9ac3e6ed9101d95bf91fa5d0655cd1ce30173dae))
* **v5.6:** remove deprecated AWS-CC-046 and the CodeCommit collector path ([d3d1a5a](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/d3d1a5ae8861ae11be31ce97e475205e9fabf502))
* **v5.7:** scan-* evidence-missing banner + profile composition cleanup + sharper evaluator reasons ([843610d](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/843610d7c750d8879caec618fae1bf4776bc56ca))
* **v5.7:** support SOURCE_DATE_EPOCH + monorepo signal fallback ([9e3c912](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/9e3c9123ed8addc76aa0d884f623c7e722701cb6))
* **v5.8.0:** expand advisory profile banner to full bundled set (F3-04) ([10a95ee](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/10a95eee4d9c823ec2b04bdc8a9ee8664ed0f636))
* **webhook:** webhook-security-2 + 6 SEC-WEBHOOK-* dimensions (PR-5) ([76aaf42](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/76aaf42de9edb508577ad1f042cb0d5a5426281a))
* **worm:** Shai-Hulud publish-defense docs + tests (PR-19) ([c62f196](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/c62f19626b5a19dc88e034ce21360f8d35d64d9d))
...
* **collect-evidence:** allow --dry-run with missing target (M-003) ([9e81667](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/9e81667bd8703f0bb163a0ca4a5335b05acd1c1c))
* **evaluate:** normalize output-dir write error to EXIT=2 (M-004) ([f45b795](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/f45b795e0de7b4ae0fa30a72c385b871003fcf53))
...
* **gitpage:** avoid Snyk false positive on policy state class ([d0a80ee](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/d0a80eec17f08737b9a59385d02e791c4ad50b14))
...
* **recommend-profile:** require BOTH CI + evidence for release-hardening-2 (M-005) ([c5600f3](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/c5600f30ddaeaab1c0607fb13e2dcd27b5fb96a9))
* remove melhorias/ reference from public doc (hygiene gate) ([0053a5d](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/0053a5d6a09346b1ff3cb5fce0771f73c22e7cec))
* **reports:** sanitize target_path by default; add --include-absolute-path (M-002) ([a8bdc29](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/a8bdc29854a2adb690eb31a8214b1694d66bfa67))
...
* **v5.6:** extract evaluators_common.py (step 1 of evaluators package) ([8220cdc](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/8220cdc92333e2c49de31f8f7adfd3331365510c))
* **v5.7:** Dockerfile.&lt;suffix&gt; discovery + CONT-RUNTIME-005 ignores comments ([57cc069](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/57cc069fe6f79f7ede99648212fa199a5bdb8432))
* **v5.7:** IAC-TF-004 cross-references separate S3 encryption resource + NOT_APPLICABLE + source-aligned scanner version ([136f585](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/136f585bed2934e6ccccc02fbdb4b44ff07c71b0))
* **v5.8.0:** introduce 5 evaluator pack shims (F2-01..F2-05) ([f0e8755](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/f0e87550a487225f852f3139582c149f4927b563))
* **v5.8.0:** move SAST-SEMGREP-064 boundary out of supply-chain (F2-05) ([ba28d6d](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/ba28d6da04981652b2918477d2209158e2b64ead))
* **v5.8.0:** strip UTF-8 BOM from 3 GitHub evidence schemas ([748a611](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/748a611f326effdf1e493c5b4c397eea8b349531))
* **workflows:** pin publish-container action SHAs to real v3 commits (v5.9.1) ([#10](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/10)) ([0d73086](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/0d73086935663fbe72f9f9b38ae117942e701998))
...
* **changelog,readme:** expand Unreleased + refresh v5.9.x stale references ([267424c](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/267424c639056b5b28876fa5c60bfb3be60355d0))
...
* **changelog:** fix stale 47/181 count in PR-18 narrative line (52/212) ([8fbea3d](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/8fbea3d554d476ed9147bf048a76c915a8484846))
* **changelog:** summarize Unreleased UX, contract, and privacy fixes ([4551097](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/45510978af4d2f57c78661f3af3cc67f8f0098d4))
...
* **container:** source-built image + provenance verification ([8e81ab5](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/8e81ab512c300d4c913a6c006ba0dcbdce7a6838))
* correct v6 positioning and public hygiene ([00daed2](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/00daed2267efb89817e1ad9fb52d28841fd4c8b9))
...
* document the full CLI surface and M-002/M-005/M-006 fixes (M-008) ([9877b83](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/9877b831a40d1fde5fd4cd49fe1a52060b4dd0a7))
...
* **examples:** strengthen vulnerable-repo README warning ([977141b](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/977141baceb44494fdfc553a980eff2ac359c608))
...
* **framework-alignment:** refresh counts + add v6.0.0 Roadmap sections (PR-2) ([09fb93c](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/09fb93cfa831575f2b7973731cb7dac575803511))
...
* **gitpage:** static JS/CSS bundle + pinned npm deps ([e4ccb86](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/e4ccb86d9962d7f73ccf9e43ed674c7f9460a83c))
...
* **hygiene:** clarify pipelines/ and waivers/ folder purposes (M-007) ([9d31081](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/9d31081705c3de6eda1f22d948c3058f6dfe5ded))
...
* public launch assets — ROADMAP, tutorial, sample reports, at-a-glance ([c91f370](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/c91f370760a8ee12f235e514ee9ad750cdb8a9d5))
* refresh pages workflow ([8eda222](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/8eda22213e6196672a35bc0bcc3a0825beee8df8))
* refresh pypi workflow ([5966405](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/596640577cedc72fa1de3a4c1ccc3271825b5fcc))
* regenerate controls-catalog (212/52) + sync counts + add generator script ([b9a569d](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/b9a569de555548fb5dc8ce40294692382a080822))
...
* scan resolved Snyk OSS manifest ([1f44f40](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/1f44f40042d89bd6901015dc5694c71f2f1d5263))
...
* update README for v5.1.0 ([f4d6ee8](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/f4d6ee8420c24c9c4f06d63c8a8f34298fb37f75))
* **v5.7:** add GOVERNANCE.md, cross-link, and catch README/CHANGELOG up to v5.6.0 ([40718c4](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/40718c41449f1fcdba2ec72e98e01132abfe5074))
* **v5.8.0:** add 15-minute quickstart (F3-08) ([e39376e](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/e39376eccfe9a67eafff883ba110dc97f81d27dd))
* **v5.8.0:** complete profile maturity matrix to all 36 bundled profiles (F3-03) ([06eb330](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/06eb330be55504f9bc05e0d4a185c3306589ad5e))
* **v5.8.0:** document catalog/profile invariant test suites (F1-08) ([30b5dcd](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/30b5dcddcfc9f3432e903c084f0a21bb51de3695))
* **v5.8.0:** document v5.8.0 evaluator boundary modules (F2-08) ([5466fad](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/5466fad05a46f5e14442b2bb86a828130231f9ed))
* **v5.8.0:** expand waivers.example.yaml with 2 posture-control examples (F1-05) ([b414435](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/b414435ca3f3c1e2f502f0d31b12b7dd7190086e))
* v6.0.0 counts refresh + ADR backfill 009/010/013 + framework-alignment (PR-33) ([410ceff](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/410ceffe584e85d0c1cac510aeb37d6edc9883e3))
* **v6:** add 8 ADRs and 5 doc stubs for v6.0.0 design baseline ([853d97a](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/853d97a3033fce2bcc6bf24bb57133a71989582a))
