...
## [11.0.0](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/compare/v10.0.25...v11.0.0) (2026-09-24)
...
* **cicd:** an unreadable workflow ended the run under nine profiles ([#326](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/326)) ([a0c83df](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/a0c83dfc09e9427122c638c26520249c37b8db7d))
...
* **ci:** the self-check and the landing page still taught the old invocation ([#302](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/302)) ([48e5bee](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/48e5beeaceab7fdc6957fe1763bf8459150df765))
...
* **cli:** a write refused for its length was reported as a missing directory ([#307](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/307)) ([299ce10](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/299ce10d96cd97494a52c9112b9194d0fb599baa))
...
* **cli:** six handlers printed the whole OSError, absolute path included ([#308](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/308)) ([d7d936d](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/d7d936db89ddeebcbd656cf6eca8b63ed3331484))
...
* **cli:** two more write failures could not name a refused length ([#323](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/323)) ([bbceed8](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/bbceed83c6114744fa00991942bf068c7e556916))
...
* **deps:** the declared python-hcl2 floor was never run, and it does not work ([#301](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/301)) ([b82ea6e](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/b82ea6e22cccdad520b13ccda456f722fcb45c2f))
...
* **docs:** the invocation the docs recommend imports the repository being scanned ([#300](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/300)) ([235f09f](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/235f09f82c1cbbc65e8dea8268a7ddb642a014d6))
* **docs:** the rebuild promise named the backend and not the platform ([#320](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/320)) ([9caca03](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/9caca033a96b9153e595e8e809c602dfac70068d))
...
* **evaluators:** the scope clause named a file the evidence did not ([#304](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/304)) ([921e883](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/921e883ae32bcebe168282da96fbaac9491d41b0))
...
* **governance:** the waiver remediation named files the control never reads ([#329](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/329)) ([9c974f7](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/9c974f70fc304ebdc5abd47067d9c9091a2b77bf))
...
* **init:** the dry run named the evidence directory, not the files it replaces ([#324](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/324)) ([b95aa31](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/b95aa3144f6c9b5b41b2752a61b581e78fbf8bac))
...
* **input:** three operator-supplied documents were read whole before any check ([#303](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/303)) ([5bbfaea](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/5bbfaeabe48116480e7b53fb1e7f7f09f92bb9e8))
...
* **loader:** three kit documents were read whole before their size was checked ([#309](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/309)) ([fab6731](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/fab6731157373c0d21db309c2bd2c70587036e51))
...
* **release:** a smoke step could disappear without the summary saying so ([#298](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/298)) ([7ce77e4](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/7ce77e4c142941b368d3d0bf2ca42618d65c8459))
...
* **release:** the consumer smoke checked exit codes and little else ([#296](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/296)) ([e0456bc](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/e0456bc2987e9a5e978ac7da84cb9898602a2db1))
* **release:** the consumer smoke could exercise the working tree, not the wheel ([#294](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/294)) ([4601624](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/46016240528f763c8caa268593a3558b7204258c))
...
* **release:** the smoke that proves the wheel left the cwd on sys.path ([#305](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/305)) ([e48711a](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/e48711ae17c85b32a292365f160e5fc7b8ce8028))
...
* **reporting:** an unpaired backtick reopened the markup escape ([#330](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/330)) ([6668dd8](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/6668dd838d197447815e57874d2c44af99eed0e7))
...
* **reporting:** raw HTML crossed the Markdown escaper ([#322](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/322)) ([6e961aa](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/6e961aac8a5377509484ffb1fe569d2017423758))
...
* **reports:** a scanned repository could put a beacon in the report ([#295](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/295)) ([d838760](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/d83876005951a0a1dc1a102ce95fbde545e927e3))
...
* **reports:** nothing ever read the digest the report carries ([#297](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/297)) ([d56cdde](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/d56cddeebe0f17de70b55586dbcd9597175401df))
...
* **action:** the pinning comment described a tag that does not exist ([#325](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/325)) ([6079968](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/6079968ddc9afb576b395d25ff7b7e440f0ebf54))
...
* **deps-dev:** bump ruff from 0.16.7 to 0.16.8 ([#311](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/311)) ([c52b97f](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/c52b97f8701eb9bf05b55b5f86bb4b4dae77a024))
...
* **deps:** bump docker/build-push-action from 7.3.0 to 7.4.0 ([#318](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/318)) ([cae96c2](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/cae96c29dd24b92f13d4e48489bfd926f207faec))
...
* **deps:** bump docker/setup-buildx-action from 4.3.0 to 4.4.1 ([#319](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/319)) ([5aeae9a](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/5aeae9a754232da15839f486992b0ceacc5d485c))
...
* **deps:** bump docker/setup-qemu-action from 4.3.0 to 4.4.0 ([#317](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/317)) ([cd5eca8](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/cd5eca81f7edce02412c010e446a3f0cfd2f89c7))
...
* **deps:** bump the codeql-action group with 4 updates ([#316](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/316)) ([3f3e290](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/3f3e2905dd2c93ea7c6bb12649652d1e7adf5e42))
...
* **deps:** regenerate the hashed locks Dependabot could not edit ([#321](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/321)) ([2d02e58](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/2d02e58167aeee5c67c342d0d462e95bdf7c7451))
...
* **package:** run the built wheel on 3.13, and say what the sdist is ([#299](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/299)) ([3a8924b](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/3a8924bc8ee3e7e9396e19e19f8368ce0ad547a9))
* **package:** the bytecode exclusion had no guard and nothing to exclude ([#328](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/328)) ([e3aadc8](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/e3aadc89f46c3df97e63435ee36e729afe5ce790))
...
* **reproducibility:** the promise named the epoch and not the other inputs ([#306](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/issues/306)) ([a1f9dce](https://github.com/lucashgrifoni/OSS-Security-Policy-as-Code-Starter-Kit/commit/a1f9dcee353d01960a5ac9e3154c48a39d40e057))
